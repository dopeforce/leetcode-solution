...
<h3><strong class="example">Example 5:</strong></h3>
<pre>
<strong>Input:</strong> <span class="example-io">s = &quot;words and 987&quot;</span>
<strong>Output:</strong> <span class="example-io">0</span>
<strong>Explanation:</strong>
<strong>Reading stops at the first non-digit character &#39;w&#39;.</strong>
</pre>
